...
public class PessoaController {
	...
	public String showSignupForm(@Param("keyword") String keyword, PersonDTO person, Model model) {
		List<PersonDTO> buscarTodas = service.buscarTodas(keyword);
	...
	public String showUpdateForm(@PathVariable("id") Long id, Model model) {
		PersonDTO person = service.buscaPessoaPorId(id)	
				.orElseThrow(() -> new IllegalArgumentException("Invalid user Id:" + id));
		List<SalaDTO> todasSalas = salaService.buscarTodas("");
		model.addAttribute("person", person);
		model.addAttribute("todasSalas", todasSalas);		
	...
	public String deleteUser(@PathVariable("id") Long id) {
	    ...
	    log.info("Pessoa deletada: {}", person);
	    return REDIRECT_PERSON;
	}
}
